...
\begin{figure}[H]
        \centering
        \subfloat[Raio = 0.1]{
                \includegraphics[width=0.3\textwidth]{figures/mandelbrot/raio/mandelbrot-250-iterations-z0(0.000000,0.000000)-radius(0.100000).png}
        }
        \subfloat[Raio = 0.2]{
                \includegraphics[width=0.3\textwidth]{figures/mandelbrot/raio/mandelbrot-250-iterations-z0(0.000000,0.000000)-radius(0.200000).png}
        }
        \subfloat[Raio = 0.4]{
                \includegraphics[width=0.3\textwidth]{figures/mandelbrot/raio/mandelbrot-250-iterations-z0(0.000000,0.000000)-radius(0.400000).png}
        }
        \\
        \subfloat[Raio = 0.75]{
                \includegraphics[width=0.3\textwidth]{figures/mandelbrot/raio/mandelbrot-250-iterations-z0(0.000000,0.000000)-radius(0.750000).png}
        }
        \subfloat[Raio = 1.0]{
                \includegraphics[width=0.3\textwidth]{figures/mandelbrot/raio/mandelbrot-250-iterations-z0(0.000000,0.000000)-radius(1.000000).png}
        }
        \subfloat[Raio = 1.25]{
                \includegraphics[width=0.3\textwidth]{figures/mandelbrot/raio/mandelbrot-250-iterations-z0(0.000000,0.000000)-radius(1.250000).png}
        }
        \\
        \subfloat[Raio = 1.55]{
                \includegraphics[width=0.3\textwidth]{figures/mandelbrot/raio/mandelbrot-250-iterations-z0(0.000000,0.000000)-radius(1.550000).png}
        }
        \subfloat[Raio = 2.0]{
                \includegraphics[width=0.3\textwidth]{figures/mandelbrot/raio/mandelbrot-250-iterations-z0(0.000000,0.000000)-radius(2.000000).png}
        }
        \subfloat[Raio = 4.0]{
                \includegraphics[width=0.3\textwidth]{figures/mandelbrot/raio/mandelbrot-250-iterations-z0(0.000000,0.000000)-radius(4.000000).png}
        }
...
Por outro lado, ao diminuir o raio de convergência, a área de cobertura é reduzida, excluindo elementos ou regiões que antes eram considerados. Isso pode acelerar o tempo de processamento, pois menos cálculos são realizados, mas pode comprometer o detalhamento e a precisão da imagem, especialmente nas regiões próximas à fronteira do conjunto de Mandelbrot.

Assim, a escolha do raio de convergência deve equilibrar o nível de detalhamento desejado e o tempo de processamento disponível, dependendo dos objetivos da análise.

Os tempos de execução para cada um dos respectivos raios de convergência são apresentados abaixo. Esses valores medem apenas o tempo gasto na execução da função de série, ou seja, não incluem o tempo de leitura e escrita dos arquivos:

\begin{table}[H]
        \centering
        \begin{tabular}{|c|c|}
                \hline
                Raio & Tempo de execução (s) \\ \hline
                0.1 & 0.360 \\ \hline
                0.2 & 0.504 \\ \hline
                0.4 & 0.422 \\ \hline
                0.75 & 0.545 \\ \hline
                ...
                4.0 & 0.833 \\ \hline
        \end{tabular}
        \caption{Tempos de execução para diferentes valores de raio de convergência.}
\end{table}
